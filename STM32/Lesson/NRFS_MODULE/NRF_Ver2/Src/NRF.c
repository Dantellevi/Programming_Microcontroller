...
void NRF24_Init(void)
{
	...
	DelayMicro(5000);
	NRF24_WriteReg(EN_AA,0x02);//Enable Pipie1
	NRF24_WriteReg(EN_RXADDR,0x02);//Enable Pipie1
	...
	NRF24_Write_Buf(TX_ADDR,TX_ADRESS,TX_ADR_WIDTH);
	NRF24_Write_Buf(RX_ADDR_P1,TX_ADRESS,TX_ADR_WIDTH);
	NRF24_WriteReg(RX_PW_P1,TX_PLOAD_WIDTH);//number of byte in Rx payload
